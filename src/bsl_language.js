    ...
    let themes = {
        rules: {
            ...
            dark: [
                ...
                { token: 'funcbsl', foreground: 'ff9191' },
                { token: 'funcdefbsl', foreground: 'ff9191' },
                { token: 'constructbsl', foreground: 'ff9191' },
                { token: 'stringbsl', foreground: 'dcdcdc' },
                { token: 'string.quotebsl', foreground: 'dcdcdc' },
                { token: 'string.invalidbsl', foreground: 'dcdcdc' },
                { token: 'numberbsl', foreground: '64eb64' },
